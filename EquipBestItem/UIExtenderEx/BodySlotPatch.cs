...
/// </summary>
[PrefabExtension(movie:"Inventory", "descendant::InventoryEquippedItemSlot[@Parameter.BackgroundBrush='InventoryArmorSlot']")]
public class BodySlotPatch : PrefabExtensionInsertPatch
{
    public override InsertType Type => InsertType.Child;
    private readonly XmlDocument _xmlDocument;
    
    public BodySlotPatch()
    {
        var button = new ButtonWidgetXmlNode(CustomEquipmentIndex.Body.ToString());
