...
/// </summary>
[PrefabExtension(movie:"Inventory", "descendant::InventoryEquippedItemSlot[@Parameter.DropTag='Equipment_1']")]
public class InventoryWeapon1SlotPatch : PrefabExtensionInsertPatch
{
    private readonly XmlDocument _xmlDocument;
    
    public InventoryWeapon1SlotPatch()
    {
        var button = new InventoryEquipButtonWidget(CustomEquipmentIndex.Weapon1);
