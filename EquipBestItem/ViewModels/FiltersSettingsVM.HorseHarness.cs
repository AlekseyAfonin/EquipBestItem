...
namespace EquipBestItem.ViewModels
{
    ...
    {
        [DataSourceProperty] public string ChargeBonusText { get; } = "Not implemented";

        [DataSourceProperty] public string ManeuverBonusText { get; } = "Not implemented";

        [DataSourceProperty] public string SpeedBonusText { get; } = "Not implemented";
        ...
        private void UpdateHorseHarnessProperties()
        {
            ...
            OnPropertyChanged(nameof(ChargeBonusValueText));
            OnPropertyChanged(nameof(ManeuverBonusValueText));
            OnPropertyChanged(nameof(SpeedBonusValueText));
        ...
        {
            var sum = Math.Abs(BodyArmorValue) +
        ...
        [DataSourceProperty] public string SpeedBonusValueText => GetHorseHarnessValuePercentText(SpeedBonusValue);
        ...
        [DataSourceProperty] public string ChargeBonusValueText => GetHorseHarnessValuePercentText(ChargeBonusValue);
